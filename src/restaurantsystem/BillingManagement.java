...
public class BillingManagement extends javax.swing.JFrame {
    ...
    private void paymentButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paymentButtonActionPerformed
        ...
        try {
            PrintWriter pw2;
            PrintWriter pw3;
            try (PrintWriter pw1 = new PrintWriter(new FileOutputStream("temp.txt"))) {
                pw2 = new PrintWriter(new FileOutputStream("storage/order.txt"));
                pw3 = new PrintWriter(new FileOutputStream("totalBill.txt", true));
